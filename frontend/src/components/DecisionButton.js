...
const DecisionButton = (props) => {
    ...
    return (
        <button onClick={props.onClick} className={classnames( "decision-button",props.text==="Accept"?'decision-button-green-background':'decision-button-red-background',props.className)}>
